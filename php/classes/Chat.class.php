...
/* Клас Chat містить публічні статичні методи, які використовуються в ajax.php */
...
class Chat{
	...
	public static function login($name,$email){
		...
		// Метод save повертає об'єкт MySQLi
	...
	public static function getUsers(){
		...
		// Видаляємо записи чату страше 5 хвилин і користувачів, неактивних протягом 30 секунд
	...
	public static function getChats($lastID){
		...
		while($chat = $result->fetch_object()){
			...
			/// Повертаємо час створення повідомлення в форматі GMT (UTC):
